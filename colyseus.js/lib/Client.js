...
class Client {
    ...
    joinById(roomId, processId, options = {}, rootSchema) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.createMatchMakeRequest("joinById", roomId, processId, options, rootSchema);
        });
    }
    /**
    ...
    reconnect(reconnectionToken, rootSchema) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.createMatchMakeRequest("reconnect", roomId, undefined, { reconnectionToken: token }, rootSchema);
        });
    }
    ...
    createMatchMakeRequest(method, roomName, processId = "", options = {}, rootSchema, reuseRoomInstance) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = (yield this.http.post(`matchmake/${method}/${roomName}/${processId}`, {
                headers: {
                    Accept: "application/json",
