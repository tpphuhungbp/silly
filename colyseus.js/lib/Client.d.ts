...
export declare class Client {
    ...
    joinById<T>(roomId: string, processId: string, options?: JoinOptions, rootSchema?: SchemaConstructor<T>): Promise<Room<T>>;
    /**
    ...
    protected createMatchMakeRequest<T>(method: string, roomName: string, processId?: string, options?: JoinOptions, rootSchema?: SchemaConstructor<T>, reuseRoomInstance?: Room): Promise<Room<T>>;
