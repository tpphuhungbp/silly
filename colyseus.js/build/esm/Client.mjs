...
class Client {
    ...
    async joinById(roomId, processId, options = {}, rootSchema) {
        return await this.createMatchMakeRequest("joinById", roomId, processId, options, rootSchema);
    }
    /**
    ...
    async reconnect(reconnectionToken, rootSchema) {
        ...
        return await this.createMatchMakeRequest("reconnect", roomId, undefined, { reconnectionToken: token }, rootSchema);
    }
    ...
    async createMatchMakeRequest(method, roomName, processId = "", options = {}, rootSchema, reuseRoomInstance) {
        const response = (await this.http.post(`matchmake/${method}/${roomName}/${processId}`, {
            headers: {
                Accept: "application/json",
